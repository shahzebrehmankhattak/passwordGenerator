...
useEffect(() => {
  ...
  return (
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500 h-52">
  ...
  <div className='flex text-sm gap-x-2 mt-8 mb-4'>
